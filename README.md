...
jevsorter propose D:\Downloads  # list filenames so you can write categories
jevsorter sort D:\Downloads     # DRY RUN - prints decisions, moves nothing
jevsorter sort D:\Downloads --apply
jevsorter undo last
```
